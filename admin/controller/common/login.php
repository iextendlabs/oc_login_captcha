...
class ControllerCommonLogin extends Controller {
	...
	public function index() {
		...
		if ($this->config->get('config_password')) {
			...
			if($this->config->get('module_login_captcha_status')){
				...
				$data['captcha'] = $this->load->controller('extension/module/captcha/basic');
				
				$data['login_captcha_status'] = $this->config->get('module_login_captcha_status');
			}
	...
	protected function validate() {
		if(!isset($this->request->post['username']) || !isset($this->request->post['password']) || !$this->request->post['username'] || !$this->request->post['password']) {
			...
			if($this->config->get('module_login_captcha_status')){
				$captcha = $this->load->controller('extension/module/captcha/' . $this->config->get('config_captcha') . '/validate');
